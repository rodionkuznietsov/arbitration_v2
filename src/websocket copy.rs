...
use crate::exchanges::{self, orderbook::BinanceOrderbookLocal};
...
pub async fn connect_async(book: Arc<RwLock<BinanceOrderbookLocal>>) {
...
async fn handle_connection(
    ...
    book: Arc<RwLock<BinanceOrderbookLocal>>,
